...
bwa mem -t 4 ecoli.contigs.fasta $reads | samtools view - -Sb | samtools sort - -@4 -o WGS.sorted.bam

samtools index WGS.sorted.bam

pilon --genome $assembly --fix all --changes --bam WGS.sorted.bam --threads 4 --outdir pilonpolish
