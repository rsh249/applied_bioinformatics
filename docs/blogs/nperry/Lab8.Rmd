...
This is where I am currently at for my project. This is all of the code that I currently have working, as well as the figures that I have made.
...
I am using this to predict the genes from the original assembly. This is still in progress, as blast2go has not been used yet.
...
I ran Transrate on the snake_venom_contigs file, along with each of the polished files for Eco6_4x8. I have not done this for the Eco8 file yet. Transrate assesses the quality of the assembly.
...
I ran NanoStat on on my Eco6 reads so that I could get summary data on the reads. I have not done this for the Eco8 data yet.
